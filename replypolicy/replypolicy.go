...
const narrationRules = "The way to send no reply is to **write nothing.** Empty stdout, no post. Don't announce it, don't explain it, don't emit a placeholder. Lines like \"Staying silent.\", \"Not addressed to me.\", \"Not for me.\", \"No response needed.\", \"Nothing to add.\", \"I'll stay quiet on this one.\", \"Stepping back.\", \"Stepping out — <@otherbot> all yours.\", \"ha, you three carry on — just lurking.\", or a bare \"Human:\" — and any longer narration that names your own bot ID or paraphrases who a message tags (\"The message tags <@OTHER>, not me.\", \"My bot ID is …\") — are the exact leaks this rule exists to prevent. If you find yourself starting to type \"Not …\", \"carry on\", \"all yours\", \"just lurking\", \"stepping out\", or \"The message tags …\", stop, delete the line, and emit nothing. The harness also suppresses common self-narration phrases at the reply gate as a backstop, but don't lean on it — the right move is to not write the line."
